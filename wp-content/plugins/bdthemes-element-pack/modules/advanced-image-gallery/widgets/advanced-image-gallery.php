...
class Advanced_Image_Gallery extends Widget_Base {
	...
	protected function render() {
		...
		if ('yes' === $settings['tilt_show']) {
			$this->add_render_attribute('advanced-image-gallery-item', 'data-tilt', '');
		}

		$this->add_render_attribute('advanced-image-gallery-item', 'class', 'bdt-width-1-'. $settings['columns_mobile']);
		$this->add_render_attribute('advanced-image-gallery-item', 'class', 'bdt-width-1-'. $settings['columns_tablet'] .'@s');
		$this->add_render_attribute('advanced-image-gallery-item', 'class', 'bdt-width-1-'. $settings['columns'] .'@m');
