...
class Custom_Carousel extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				...
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'navigation' => [ 'arrows', 'dots', 'both', 'arrows-fraction', 'progress' ],
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-custom-carousel .bdt-navigation-prev svg, {{WRAPPER}} .bdt-custom-carousel .bdt-navigation-next svg' => 'background-color: {{VALUE}}',
				],
				'condition' => [
					'navigation!' => [ 'dots', 'progress', 'none' ],
				],
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-custom-carousel .bdt-navigation-prev:hover svg, {{WRAPPER}} .bdt-custom-carousel .bdt-navigation-next:hover svg' => 'background-color: {{VALUE}}',
				],
				'condition' => [
					'navigation!' => [ 'dots', 'progress', 'none' ],
				],
		...
		$this->add_control(
			...
			[
				...
				'separator'  => 'after',
				'selectors'  => [
					'{{WRAPPER}} .bdt-custom-carousel .bdt-navigation-prev svg, {{WRAPPER}} .bdt-custom-carousel .bdt-navigation-next svg' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [
					'navigation!' => [ 'dots', 'progress', 'none' ],
				],
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'navigation!' => [ 'arrows', 'arrows-fraction', 'progress', 'none' ],
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'navigation!' => [ 'arrows', 'dots', 'progress', 'none' ],
				],
			]
		);
	...
	protected function render_pagination() {
		...
		<?php elseif ( 'progress' == $settings['navigation'] ) : ?>
	...
	protected function render_script() {
		...
		} elseif ('progress' == $settings['navigation'] ) {
		...
		$swiper_script = [
			...
			'paginationType'      => esc_attr($pagination_type),
			'paginationClickable' => true,
			'nextButton'          => '#bdt-custom-carousel-'. $id .' .bdt-navigation-next',
			'prevButton'          => '#bdt-custom-carousel-'. $id .' .bdt-navigation-prev',
