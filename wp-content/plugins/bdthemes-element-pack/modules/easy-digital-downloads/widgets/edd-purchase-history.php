...
class EDD_Purchase_History extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Easy Digital Downloads Purchase History', 'bdthemes-element-pack' );
	}

	public function get_icon() {
		return 'bdt-widget-icon eicon-file-download';
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} #edd_user_history table' => 'border-style: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} #edd_user_history table' => 'border-width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#ccc',
				'selectors' => [
					'{{WRAPPER}} #edd_user_history table' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#fff',
				'selectors' => [
					'{{WRAPPER}} #edd_user_history .bdt-odd td' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} #edd_user_history .bdt-odd td' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#ccc',
				'selectors' => [
					'{{WRAPPER}} #edd_user_history .bdt-odd td' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#f7f7f7',
				'selectors' => [
					'{{WRAPPER}} #edd_user_history .bdt-even td' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} #edd_user_history .bdt-even td' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#ccc',
				'selectors' => [
					'{{WRAPPER}} #edd_user_history .bdt-even td' => 'border-color: {{VALUE}};',
				],
			]
		);
	...
	protected function render() {
		...
		<script>
			jQuery(document).ready(function($) {
			    $('#edd_user_history tr:odd').addClass('bdt-odd');
			    $('#edd_user_history tr:even').addClass('bdt-even');
			});
		</script>
		<?php
	}
