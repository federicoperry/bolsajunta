...
class Easy_Digital_Downloads extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Easy Digital Downloads', 'bdthemes-element-pack' );
	}
	...
	private function get_shortcode() {
		...
		$attributes = [
			...
			'thumbnails' => ('yes' === $settings['edd_thumbnail_show']) ? 'true' : 'false',
			'excerpt'    => ('yes' === $settings['edd_excerpt_show']) ? 'yes' : 'no',
			'price'      => ('yes' === $settings['edd_price_show']) ? 'yes' : 'no',
			'buy_button' => ('yes' === $settings['edd_buy_button']) ? 'yes' : 'no',
			'pagination' => ('yes' === $settings['edd_pagination_show']) ? 'true' : 'false',
		];
