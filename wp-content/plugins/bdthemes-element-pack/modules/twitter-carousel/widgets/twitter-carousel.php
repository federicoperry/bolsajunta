...
class Twitter_Carousel extends Widget_Base {
	...
	public function get_title() {
		return __( 'Twitter Carousel', 'bdthemes-element-pack' );
	}
	...
	private function register_query_section_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-twitter-carousel .bdt-carousel-item .bdt-twitter-text, {{WRAPPER}} .bdt-twitter-carousel .bdt-carousel-item .bdt-twitter-text *' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .bdt-twitter-carousel .bdt-carousel-item' => 'box-shadow: {{HORIZONTAL}}px {{VERTICAL}}px {{BLUR}}px {{SPREAD}}px {{COLOR}};',
		        ],
		        'condition' => [
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .bdt-twitter-carousel .bdt-carousel-item:hover' => 'box-shadow: {{HORIZONTAL}}px {{VERTICAL}}px {{BLUR}}px {{SPREAD}}px {{COLOR}};',
		        ],
		        'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-carousel .bdt-navigation-prev svg, {{WRAPPER}} .bdt-carousel .bdt-navigation-next svg' => 'background-color: {{VALUE}}',
				],
				'condition' => [
					'navigation' => [ 'arrows', 'both' ],
				],
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-carousel .bdt-navigation-prev:hover svg, {{WRAPPER}} .bdt-carousel .bdt-navigation-next:hover svg' => 'background-color: {{VALUE}}',
				],
				'condition' => [
					'navigation' => [ 'arrows', 'both' ],
				],
		...
		$this->add_control(
			...
			[
				...
				'separator'  => 'after',
				'selectors'  => [
					'{{WRAPPER}} .bdt-carousel .bdt-navigation-prev svg, {{WRAPPER}} .bdt-carousel .bdt-navigation-next svg' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [
					'navigation' => [ 'arrows', 'both' ],
				],
	...
	public function render_loop_twitter() {
		$settings          = $this->get_settings();
		$options           = get_option( 'element_pack_api_settings' );
		
		$consumerKey       = (!empty($options['twitter_consumer_key'])) ? $options['twitter_consumer_key'] : 'c5LxvIawWfHidBp6MAhguTFDL';
		$consumerSecret    = (!empty($options['twitter_consumer_secret'])) ? $options['twitter_consumer_secret'] : 'FXJ8UxHg3T4cbQVblAU6mOPmWjyDkgIz5JLo6iX0spI1nVxHoh';
		$accessToken       = (!empty($options['twitter_access_token'])) ? $options['twitter_access_token'] : '746072074221871104-w3nDxL3Jmk1UsuuLeLk0i6tU036qrC9';
		$accessTokenSecret = (!empty($options['twitter_access_token_secret'])) ? $options['twitter_access_token_secret'] : 'L4xqb2clpWD1K3pyR7vQASeqvq6z4Nrfqg3wNfp45U31W';
		$twitter_name      = (!empty($options['twitter_name'])) ? $options['twitter_name'] : 'bdthemescom';
	...
	protected function render_loop_header() {
		...
		$this->add_render_attribute( 'carousel', 'id', 'bdt-twitter-carousel-' . $id );
	...
	protected function render_footer() {
		...
		<script>
			jQuery(document).ready(function($) {
			    "use strict";				    
			    var swiper = new Swiper("#bdt-twitter-carousel-<?php echo $id;?> .swiper-container", {
			        "pagination": "#bdt-twitter-carousel-<?php echo $id;?> .swiper-pagination",
			        "paginationClickable":true,
			        "nextButton": "#bdt-twitter-carousel-<?php echo $id;?> .bdt-navigation-next",
			        "prevButton": "#bdt-twitter-carousel-<?php echo $id;?> .bdt-navigation-prev",
