...
class Gravity_Forms extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Gravity Forms', 'bdthemes-element-pack' );
	}
    ...
    //             ],
        ...
        $this->add_responsive_control(
            ...
            [
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
                    '{{WRAPPER}} .bdt-custom-radio-checkbox input[type="checkbox"], 
                     {{WRAPPER}} .bdt-custom-radio-checkbox input[type="radio"]' => 'width: {{SIZE}}{{UNIT}} !important; height: {{SIZE}}{{UNIT}}',
                ],
				'condition' => [
        ...
        $this->add_control(
            ...
            [
				...
				'selectors' => [
                    '{{WRAPPER}} .bdt-custom-radio-checkbox input[type="checkbox"], 
                     {{WRAPPER}} .bdt-custom-radio-checkbox input[type="radio"]' => 'background: {{VALUE}}',
                ],
				'condition' => [
                    'custom_radio_checkbox' => 'yes',
                ],
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .bdt-custom-radio-checkbox input[type="checkbox"], 
					 {{WRAPPER}} .bdt-custom-radio-checkbox input[type="checkbox"]:before' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
                'condition'             => [
                    'custom_radio_checkbox' => 'yes',
                ],
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-custom-radio-checkbox input[type="radio"], 
					 {{WRAPPER}} .bdt-custom-radio-checkbox input[type="radio"]:before' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
                'condition'             => [
                    'custom_radio_checkbox' => 'yes',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default'               => '',
                'selectors'             => [
                    '{{WRAPPER}} .bdt-custom-radio-checkbox input[type="checkbox"]:checked:before, 
                    {{WRAPPER}} .bdt-custom-radio-checkbox input[type="radio"]:checked:before' => 'background: {{VALUE}}',
                ],
                'condition'             => [
                    'custom_radio_checkbox' => 'yes',
                ],
	...
	private function get_shortcode() {
		...
		//[wpforms id="20442" title="false" description="false"]
	...
	public function render() {
		...
		//     $this->add_render_attribute( 'contact-form', 'class', 'bdt-custom-radio-checkbox' );
		// }
