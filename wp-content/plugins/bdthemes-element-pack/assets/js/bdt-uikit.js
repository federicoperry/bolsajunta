...
(function (global, factory) {
    ...
    */
    ...
    function hooksAPI (bdtUIkit) {
        ...
        bdtUIkit.prototype._callReady = function () {
    ...
    function stateAPI (bdtUIkit) {
        ...
        bdtUIkit.prototype._resetComputeds = function () {
            this._computeds = {};
        };
    ...
    function Core (bdtUIkit) {
        ...
        ready(function () {
            ...
            on(window, 'load resize', function (e) { return bdtUIkit.update(null, e); });
            on(window, 'scroll', function (e) {
                e.dir = scroll <= window.pageYOffset ? 'down' : 'up';
                e.pageYOffset = scroll = window.pageYOffset;
                bdtUIkit.update(null, e);
            ...
            Object.defineProperty(bdtUIkit, 'hoverSelector', {
            ...
            bdtUIkit.hoverSelector = '.bdt-animation-toggle, .bdt-transition-toggle, [bdt-hover]';
...

            {
                ...
                handler: function handler(ref) {
                    ...
                    if (current === this.input) {
                        toggleClass(
                            this.state,
                            ("bdt-" + (includes(type, 'focus') ? 'focus' : 'hover')),
    ...
    function install(bdtUIkit) {
        bdtUIkit.icon.add = function (added) {
            ...
            if (bdtUIkit._initialized) {
                apply(document.body, function (el) {
                    var icon = bdtUIkit.getComponent(el, 'icon');
                    if (icon) {
                        icon.$reset();
                    }
                });
    ...
    var Offcanvas = {
        ...
        data: {
            ...
            clsContent: 'bdt-offcanvas-content',
            clsContentAnimation: 'bdt-offcanvas-content-animation',
    ...
    var OverflowAuto = {
        ...
        computed: {
            ...
            modal: function modal(_, $el) {
                return closest($el, '.bdt-modal');
            },

            panel: function panel(_, $el) {
                return closest($el, '.bdt-modal-dialog');
            }
        ...
        methods: {
            ...
            show: function show(item) {
                ...
                for (var i = 0; i < length; i++, next = (next + dir + length) % length) {
                    if (!matches(this$1.toggles[next], '.bdt-disabled, [disabled]')) {
        ...
        update: [

            {
                ...
                write: function write() {
                    ...
                    toggleClass($$(this.navItemSelector, this.$el).concat(this.nav), 'bdt-hidden', !this.maxIndex);
