...
class Element_Pack_Loader {
	...
	private function _includes() {
		...
		if ( is_admin() ) {
			if(!defined('ELEMENT_PACK_CONFIG_HIDE')) {
				require BDTEP_PATH . 'includes/admin.php';
			}
			if(!defined('ELEMENT_PACK_AS_THEME')) {
	...
	public function register_site_scripts() {
		...
		wp_register_script( 'bdt-uikit-icons', BDTEP_URL . 'assets/js/bdt-uikit-icons' . $suffix . '.js', ['jquery', 'bdt-uikit'], '3.0.0.42', true );
		...
		wp_register_script( 'jplayer', BDTEP_URL . 'assets/vendor/js/jquery.jplayer' . $suffix . '.js', ['jquery'], '', true );
		wp_register_script( 'weather', BDTEP_URL . 'assets/vendor/js/jquery.flatWeatherPlugin' . $suffix . '.js', ['jquery'], '', true );
		wp_register_script( 'circle-menu', BDTEP_URL . 'assets/vendor/js/jQuery.circleMenu' . $suffix . '.js', ['jquery'], '', true );
		wp_register_script( 'cookieconsent', BDTEP_URL . 'assets/vendor/js/cookieconsent' . $suffix . '.js', ['jquery'], '', true );
	...
	public function enqueue_site_scripts() {
		...
		wp_enqueue_script( 'element-pack-site', BDTEP_URL . 'assets/js/element-pack-site' . $suffix . '.js', ['jquery'], BDTEP_VER );
